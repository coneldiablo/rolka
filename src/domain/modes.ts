...
export const MODE_PROMPTS: Record<RpMode, string> = {
  ...
  ADULT: [
    "Режим 18+ Adult.",
    "Adult-only вымышленный roleplay допустим только если все персонажи совершеннолетние, взаимодействие добровольное и safety-условия соблюдены.",
    "Если пользователь явно начинает adult-интимность и ограничения соблюдены, пиши естественно, конкретно и без эвфемистичных ИИ-клише, сохраняя умеренную длину постов и место для ответа пользователя.",
